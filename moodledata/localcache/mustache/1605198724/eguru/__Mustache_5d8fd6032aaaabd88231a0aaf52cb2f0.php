...
class __Mustache_5d8fd6032aaaabd88231a0aaf52cb2f0 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        if ($parent = $this->mustache->loadPartial('core_form/element-template-inline')) {
            $context->pushBlockContext(array(
                'element' => array($this, 'block171c8d793c5790e3057e3daf36af8dcc'),
            ));
...
';
    ...
    public function block171c8d793c5790e3057e3daf36af8dcc($context)
    {
        $indent = $buffer = '';
