...
class __Mustache_34ac22a06c1de971dfaa145d2d9e9e7b extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $indent . '<div class="message d-flex row-fluid"
';
...
';
        ...
        $buffer .= '">
';
        $buffer .= $indent . '        <span dir="auto" align="initial" class="text" data-region="message-text">
';
        $buffer .= $indent . '            ';
