...
/**
 * Strings for component 'hub', language 'es', version '3.5'.
 *
 * @package     hub
 * @category    string
...
$string['errorhublisting'] = 'Se produjo un error al recuperar el listado de Centrales de Cursos de Moodle, por favor, inténtelo de nuevo más tarde. ({$a})';
...
$string['registermoochtips'] = 'Registre su portal en Moodle para recibir alertas de seguridad y acceso a Moodle.net, nuestra plataforma de cursos.';
