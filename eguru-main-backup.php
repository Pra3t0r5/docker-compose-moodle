...
function theme_eguru_get_pattern_color($css, $type = '')
{
    ...
    $patterncolors = array(
        ...
        '2' => array(
            'color_primary' => '#1e2336',
            'color_secondary' => '#183054',
            'color_blackcurrant_approx' => '#6A4ACA',
            'color_plum_approx' => '#2f8cad',
            'color_blackcurrant_90_approx' => 'rgba(106,74,202,0.90)',
            'color_french_lilac_approx' => '#ccd8e',
            'color_snuff_approx' => '#c0ccdc',
            'color_tutu_approx' => '#e8e8e8',
            'color_blackcurrant_25_approx' => 'rgba(106,74,202,0.25)',
